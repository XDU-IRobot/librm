...
/**
 * @file  librm/modules/ahrs/kalman_filter.hpp
 * @brief Kalman Filter
 */

#ifndef LIBRM_MODULES_AHRS_KALMAN_FILTER_HPP
#define LIBRM_MODULES_AHRS_KALMAN_FILTER_HPP
...
inline int arm_mat_add_f32(const arm_matrix_instance_f32 *pSrcA, const arm_matrix_instance_f32 *pSrcB, arm_matrix_instance_f32 *pDst) { return 0; }
inline int arm_mat_sub_f32(const arm_matrix_instance_f32 *pSrcA, const arm_matrix_instance_f32 *pSrcB, arm_matrix_instance_f32 *pDst) { return 0; }
inline int arm_mat_mult_f32(const arm_matrix_instance_f32 *pSrcA, const arm_matrix_instance_f32 *pSrcB, arm_matrix_instance_f32 *pDst) { return 0; }
